...
public class GrievanceController {
	...
	//***************************************** view Grievance controller *********************************
	@RequestMapping(value="/saveGrievanceMessage",method ={org.springframework.web.bind.annotation.RequestMethod.POST},consumes = "multipart/form-data")
	public @ResponseBody GenricResponse saveGrievanceReply(@RequestParam(name="files[]",required = false) MultipartFile[] fileUpload ,HttpServletRequest request,HttpSession session)
	{
