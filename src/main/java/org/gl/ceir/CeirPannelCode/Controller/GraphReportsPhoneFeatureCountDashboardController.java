...
@Controller
public class GraphReportsPhoneFeatureCountDashboardController {
	...
	@RequestMapping(value=
		{"/PhoneFeatureCountDashboard"},method={org.springframework.web.bind.annotation.
				RequestMethod.GET,org.springframework.web.bind.annotation.RequestMethod.POST}
			)
	    public ModelAndView viewConfigManagement(HttpSession session) {
		ModelAndView mv = new ModelAndView();
		 log.info(" view PhoneFeatureCountDashboard entry point."); 
		 mv.setViewName("viewsPhoneFeatureCountDashboard");
		log.info(" view PhoneFeatureCountDashboard exit point."); 
		return mv; 
	}
//	
