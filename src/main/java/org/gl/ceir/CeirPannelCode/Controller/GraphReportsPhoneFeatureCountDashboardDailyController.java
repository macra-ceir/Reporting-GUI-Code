...
@Controller
public class GraphReportsPhoneFeatureCountDashboardDailyController {
	...
	@RequestMapping(value=
		{"/PhoneFeatureCountDashboard_Daily"},method={org.springframework.web.bind.annotation.
				RequestMethod.GET,org.springframework.web.bind.annotation.RequestMethod.POST}
			)
	    public ModelAndView viewConfigManagement(HttpSession session) {
		ModelAndView mv = new ModelAndView();
		 log.info(" view PhoneFeatureCountDashboard_Daily entry point."); 
		 mv.setViewName("viewsPhoneFeatureCountDashboard_Daily");
		log.info(" view PhoneFeatureCountDashboard_Daily exit point."); 
		return mv; 
	}
