...
private final Logger log = LoggerFactory.getLogger(getClass());
	...
	public ResponseEntity<?> pageRendering(@RequestParam(name="type",defaultValue = "Config",required = false) String role,HttpSession session){
		...
		List<InputFields> inputTypeDateList = new ArrayList<>();
			...
			String[] dateParam= {"date","Creation Start Date","startDate","","date","Creation End Date","endDate","","text","Description","descriptionID","50","text","Value","valueID","50","select","Type","type","","select","Module Name","featureName",""};
