...
public class IconsState {
	...
	public String iconsDeviceManagement (String tac,String requestType,Integer deviceState) {
		executePostConstruct();
		// URL link 
		//log.info("status---->"+status+"---------AdminCurrentStatus------>"+AdminCurrentStatus+" userStatus----------->" +userStatus);
		String action = null;
		String viewHistoryAction="viewDetails('"+tac+"','viewDetailHistory')";
		...
		if("multiedit".equals(requestType)) {
			...
			String copy = "<div class='d-flex'><a onclick="+CopyAction+" class=\"waves-effect waves-light modal-trigger\"  data-dismiss=\"modal\"><i class="+copyIcon+" aria-hidden=\"true\" title="
					+CopyTitle+" ></i></a>";
			...
			String viewIcon = "<a onclick="+viewHistoryAction+" class=\"dropdown-item\" title="+viewIconTitle+"><img src=\"./resources/assets/images/eye-icon.svg\" alt=\"icon\" class=\"img-fluid\"></a>";
			action=viewIcon;
		}
		else {
			String threeDot = "<div class=\"dropdown\"><a class=\"nav-link dropdown-toggle text-center p-0\" href=\"#\" id=\"navbardrop\" data-toggle=\"dropdown\" aria-expanded=\"false\">︙</a>"
					...
					+"<a onclick="+editAction+" class=\"dropdown-item\" href=\"#\"><img src=\"./resources/assets/images/edit-icon.svg\" alt=\"icon\" class=\"img-fluid\">  "+editIconTitle+"</a>"
