...
<body data-roleType="${usertype}" data-userTypeID="${usertypeId}" data-userID="${userid}" data-selected-roleType="${selectedUserTypeId}" 
	...
	<div id="viewAdminSystemModel" class="modal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg" role="document">
		  <div class="modal-content">
				<h5 class="modal-header"><spring:message code="modal.Configuration" /></h5>
			<div class="modal-body">
				<div class="form-row">
					...
					<!-- <div class="form-group col-md-6">
						...
						<input type="text" id="editmodifiedBy" class="form-control" name="value" disabled>
					</div> -->
				
					
					<%-- <div class="form-group col-md-6">
						<label for="viewValue" class=""><spring:message code="registration.value" /> </label>
					<textarea id="viewValue" class="materialize-textarea form-control" Placeholder="" title="Please enter alphabets and numbers upto 100 characters only" maxlength="100" readonly="readonly" style="min-height:8rem"></textarea>
					</div> --%>
