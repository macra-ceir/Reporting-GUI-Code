...
<div class="content-box">
                        ...
                        <li>
                            ...
                            <li><a href="#">Year<br> 2000 (2 more)</a></li> -->
                                ...
                                <ul class="nav nav-tabs product-tabs border-0">
                                    <li><a data-toggle="tab" href="#tab1" class="active">Device Counts Till Date</a></li>
                                    <li><a data-toggle="tab" href="#tab2">Device Count (Month on Month)</a></li>
                                    <li><a data-toggle="tab" href="#tab3">Device Count (Qtr on Qtr)</a></li>
                                    <li><a data-toggle="tab" href="#tab4">Device Count (Yr on Yr)</a></li>
                                    <li><a data-toggle="tab" href="#tab5">Tabular Data by Month</a></li>
                                    <li><a data-toggle="tab" href="#tab6">Operator Wise Device Count (Month on Month)</a></li>
                                    <li><a data-toggle="tab" href="#tab7">Operator Wise Device Count (Qtr on Qtr)</a></li>
                                    <li><a data-toggle="tab" href="#tab8">Operator Wise Device Count (Yr on Yr)</a></li>
                                </ul>
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/viewsPhoneFeatureCountDashboard.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
