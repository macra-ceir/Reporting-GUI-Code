		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						<label for="description" class=""><spring:message code="registration.tag" /></label>
					<textarea id="viewTag" class="materialize-textarea form-control" placeholder="Tag" readonly="readonly" style="min-height:8rem"></textarea>
					</div>
					<div class="form-group col-md-6">
				...
				<div class="modal-content_">
					<form action="" onsubmit="return updateSystem()">
						...
						<!-- 		<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									<label for="tag" class=""><spring:message code="registration.tag" /></label>
									<input type="text" id="editTag" class="form-control" name="editTag" placeholder="" maxlength="100" disabled>
