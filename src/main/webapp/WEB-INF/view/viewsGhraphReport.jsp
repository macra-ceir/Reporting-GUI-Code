...
<div class="content-box">
                                            ...
                                            <div class="row" id="content_download_tab1">
                                            	 <div class="col-md-6 mb-16">
                                                   <!-- <h3>Till Date Reason For Valid IMEI with % change</h3> -->
													<div id="tillDateImeiCountValid_invalid" class="graph_display"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                   <!-- <h3>Till date : IMEI count Invalid </h3> -->
													<div id="tillDateInvalidCountByReason" class="graph_display"></div>
                                                </div>
                                                
                                             	<div class="col-md-6 mb-16">
                                                  <!--  <h3>Top OS with Percentage</h3> -->
													<div id="TopOSwithPercentage" class="graph_display"></div>
                                                </div>
                                                
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3>Till date : DeviceType </h3> -->
													<div id="DeviceTypeTillDate" class="graph_display"></div>
                                                </div>
                                            
                                            
                                            
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3 Id="deviceTypeOSTillDate_heading">Top Device Type for Android</h3> -->
													<div id="deviceTypeOSTillDate" class="graph_display"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                  <!--  <h3 Id="deviceTypeLikeSmartphoneTillDate_heading">Top OS Type for Device Type : Smart Phone till Date</h3> -->
													<div id="deviceTypeLikeSmartphoneTillDate" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                   <!-- <h3>Top 5 Brand Till Date</h3> -->
													<div id="TopBrandNameTillDate" class="graph_display"></div>
                                                </div>
                                                
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3>top Model Name Till Date</h3> -->
													<div id="topmodelnameTillDate" class="graph_display"></div>
                                                </div>
                                            	
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3>Top Marketing Name with Percentage</h3> -->
													<div id="topMarketingNamewithPercentage109" class="graph_display"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                  	<!-- <h3>Supporting Technology with Percentage</h3> -->
													<div id="supportingTechnologywithPercentage110" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<!-- <h3>IMEI Count by Operator Name</h3> -->
													<div id="ImeiCountbyOperator" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<!-- <h3 id="Top5Brands_heading">Top 5 Brands for Aitel Till Date</h3> -->
													<div id="Top5Brands" class="graph_display"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                  	<!-- <h3 id="Top5OS_heading">Top 5 OS for Aitel Till Date</h3> -->
													<div id="Top5OS" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<!-- <h3 id="Top5DeviceType_heading">Top 5 Device Type for Aitel Till Date</h3> -->
													<div id="Top5DeviceType" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<!-- <h3 id="Top5Models_heading">Top 5 Models for Aitel Till Date</h3> -->
													<div id="Top5Models" class="graph_display"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                  	<!-- <h3 id="Top5MarketingName_heading">Top 5 Marketing Name for Aitel Till Date</h3> -->
													<div id="Top5MarketingName" class="graph_display"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                  	<!-- <h3 id="Top5SupportedTechnologies_heading">Top 5 Supported Technologies for Aitel Till Date</h3> -->
													<div id="Top5SupportedTechnologies" class="graph_display"></div>
                                                </div>
                                                
                                                
                                                 <!-- <div class="col-md-6 mb-16">
                                                  	<h3>Monthly Report</h3>
													<div id="container103" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Yearly Report</h3>
													<div id="container104" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Quarterly Report</h3>
													<div id="container105" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Till Date Count Report</h3>
													<div id="container11" class="graph_display"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Brand Count Monthly Report</h3>
													<div id="container12" class="graph_display"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Brand Count Quarter Report</h3>
													<div id="container13" class="graph_display"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Valid-Invalid Feature Report</h3>
													<div id="container14" class="graph_display"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Till Date Pie Report</h3>
													<div id="container1001" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Dual Axis Apple Report</h3>
													<div id="container1111" class="graph_display"></div>
                                                </div> -->
                                            ...
                                            <div class="row">
                                            	<div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="MonthlyTopMarketingName" class="graph_display"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="MonthlyTopBrandName" class="graph_display"></div>
                                                </div>
                                                
                                                <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="MonthlyTopModelName" class="graph_display"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="MonthlyTopDeviceType" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="MonthlyTopSupportingTech" class="graph_display"></div>
                                                </div>
                                                 <!-- <div class="col-md-6 mb-16">
                                                   <h3>In Valid Imei Count with % Change </h3>
													<div id="MonthlyTopDeviceType" class="graph_display"></div>
                                    ...
                                    <div id="tab3" class="tab-pane fade">
                                        ...
                                        <div class="product-detail-list">
                                            <div class="row">
                                                <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="QuarterlyTopMarketingName" class="graph_display"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="QuarterlyTopBrandName" class="graph_display"></div>
                                                </div>
                                                
                                                <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="QuarterlyTopModelName" class="graph_display"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="QuarterlyTopDeviceType" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="QuarterlyTopSupportingTech" class="graph_display"></div>
                                                </div>
                                    ...
                                    <div id="tab4" class="tab-pane fade">
                                        ...
                                        <div class="product-detail-list">
                                            <div class="row">
                                               <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="YearlyTopMarketingName" class="graph_display"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="YearlyTopBrandName" class="graph_display"></div>
                                                </div>
                                                
                                                <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="YearlyTopModelName" class="graph_display"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="YearlyTopDeviceType" class="graph_display"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="YearlyTopSupportingTech" class="graph_display"></div>
                                                </div>
                                   ...
                                   <!--  <div id="tab5" class="tab-pane fade">
                                    ...
                                    <div id="tab6" class="tab-pane fade">
                                        ...
                                        <div class="product-detail-list">
                                            <div class="row">
                                                <div class="col-md-6 mb-16">
                                                    <div id="MonthlyOperatorWise128_3" class="graph_display"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                    <div id="InValidMonthlyOperatorWise129_3" class="graph_display"></div>
                                                </div>

                                                <div class="col-md-6 mb-16">
                                                    <div id="ValidMonthlyMobileOperatorWise130_3" class="graph_display"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                    <div id="InValidMonthlyMobileOperatorWise131_3" class="graph_display"></div>
                                                </div>
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/viewsGhraphReport.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
