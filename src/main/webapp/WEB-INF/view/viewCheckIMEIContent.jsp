	...
	<div id="viewAdminSystemModel" class="modal" tabindex="-1" role="dialog">
		<div class="modal-dialog modal-lg" role="document">
		  <div class="modal-content">
				<h5 class="modal-header"><spring:message code="modal.IMEI-Content-Configuration" /></h5>
			<div class="modal-body">
				<div class="form-row">
					<%-- <div class="form-group col-md-6">
						<label for="viewValue" class=""><spring:message code="registration.value" /></label>
						<input type="text" id="viewValue" class="materialize-textarea form-control" placeholder="Value" readonly="readonly">
					</div> --%>
					...
					<div class="form-group col-md-12">
						<label for="description" class=""><spring:message code="table.english_name" /></label>
					<textarea id="viewenglish_name" class="materialize-textarea form-control" placeholder="english name" readonly="readonly" style="min-height:5rem"></textarea>
					</div>
					<div class="form-group col-md-12">
						<label for="description" class=""><spring:message code="table.khmer_name" /></label>
					<textarea id="viewkhmer_name" class="materialize-textarea form-control" placeholder="khmer name" readonly="readonly" style="min-height:5rem"></textarea>
					</div>
					
					<div class="form-group col-md-6">
						<label for="type"><spring:message code="table.label" /></label>
						<input type="text" id="viewlabel" name="label" class="form-control"
							placeholder="label" maxlength="20" disabled>
