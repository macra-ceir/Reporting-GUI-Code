                        ...
                        <li>
                            ...
                            <li><a href="#">Year<br> 2000 (2 more)</a></li> -->
                                ...
                                <ul class="nav nav-tabs product-tabs border-0">
                                    <li><a data-toggle="tab" href="#tab1" class="active">IMEI Counts Till Date</a></li>
                                    <li><a data-toggle="tab" href="#tab2">IMEI Counts Month</a></li>
                                    <li><a data-toggle="tab" href="#tab3">IMEI Counts Qtr</a></li>
                                    <li><a data-toggle="tab" href="#tab4">IMEI Counts Yr</a></li>
                                    <li><a data-toggle="tab" href="#tab11">Tabular Data by</a></li>
                                    <li><a data-toggle="tab" href="#tab5">Operator Wise</a></li>
                                    <li><a data-toggle="tab" href="#tab6">Operator Wise</a></li>
                                    <li><a data-toggle="tab" href="#tab7">Operator Wise </a></li>
                                </ul>
                                        ...
                                        <div class="product-detail-list">
                                            <div class="row">
                                            	 <div class="col-md-6 mb-16">
                                                  <!--  <h3>Till Date Reason For Invalid Imei with % change</h3> -->
													<div id="tillDateInvalidCountByReason" style="border-style: solid"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                   <!-- <h3>Till date : imei count valid/invalid </h3> -->
													<div id="tillDateImeiCountValid_invalid" style="border-style: solid"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                   <!-- <h3>Till date : Invalid Count By Reason</h3> -->
													<div id="tillDateReasonForInvalidImei" style="border-style: solid"></div>
                                                </div>
                                            	<div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="validImeiCountWithPerChange" style="border-style: solid"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="inValidImeiCountWithPerChange" style="border-style: solid"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3>Till date : Top Os </h3> -->
													<div id="tillDateTopOs" style="border-style: solid"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3>Till date : DeviceType </h3> -->
													<div id="DeviceTypeTillDate" style="border-style: solid"></div>
                                                </div>
                                            	<div class="col-md-6 mb-16">
                                                   <!-- <h3>Top OS with Percentage</h3> -->
													<div id="TopOSwithPercentage" style="border-style: solid"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3>Top Marketing Name with Percentage</h3> -->
													<div id="TopMarketingNamewithPercentage" style="border-style: solid"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                   <!-- <h3>SupportingTechnology With Percentage</h3> -->
													<div id="supportingTechnologywithPercentage110" style="border-style: solid"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                   <!-- <h3>Imei count by operator</h3> -->
													<div id="ImeiCountbyOperator" style="border-style: solid"></div>
                                                </div>
                                            	
                                                <!-- <div class="col-md-6 mb-16">
                                                   <h3>Apple Monthly Report</h3>
													<div id="container201" style="border-style: solid"></div>
                                                </div>
                                                <div class="col-md-6 mb-16">
                                                  	<h3>Till Date Report</h3>
													<div id="container101" style="border-style: solid"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Daily Report</h3>
													<div id="container102" style="border-style: solid"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Monthly Report</h3>
													<div id="container103" style="border-style: solid"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Yearly Report</h3>
													<div id="container104" style="border-style: solid"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Quarterly Report</h3>
													<div id="container105" style="border-style: solid"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Till Date Count Report</h3>
													<div id="container11" style="border-style: solid"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Brand Count Monthly Report</h3>
													<div id="container12" style="border-style: solid"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Brand Count Quarter Report</h3>
													<div id="container13" style="border-style: solid"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Valid-Invalid Feature Report</h3>
													<div id="container14" style="border-style: solid"></div>
                                                </div>
                                                
                                                  <div class="col-md-6 mb-16">
                                                  	<h3>Till Date Pie Report</h3>
													<div id="container1001" style="border-style: solid"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  	<h3>Dual Axis Apple Report</h3>
													<div id="container1111" style="border-style: solid"></div>
                                                </div> -->
                                    ...
                                    <div id="tab4" class="tab-pane fade">
                                        <div class="product-detail-list">
                                            <div class="row">
                                               <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="YearlyTopMarketingName" style="border-style: solid"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="YearlyTopBrandName" style="border-style: solid"></div>
                                                </div>
                                                
                                                <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="YearlyTopModelName" style="border-style: solid"></div>
                                                </div>
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>In Valid Imei Count with % Change </h3> -->
													<div id="YearlyTopDeviceType" style="border-style: solid"></div>
                                                </div>
                                                
                                                 <div class="col-md-6 mb-16">
                                                  <!--  <h3>Valid Imei Count with % Change</h3> -->
													<div id="YearlyTopSupportingTech" style="border-style: solid"></div>
                                                </div>
