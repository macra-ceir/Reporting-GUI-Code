...
<div class="content-box">
                        ...
                        <li>
                            ...
                            <li><a href="#">Year<br> 2000 (2 more)</a></li> -->
                                ...
                                <ul class="nav nav-tabs product-tabs border-0">
                                    <li><a data-toggle="tab" href="#tab1" class="active">TAC Allocation Month's IMEI Count</a></li>
                                        ...
                                        <div class="product-detail-list">
                                            <div class="row">
                                            	 <div class="col-md-6 mb-16">
                                                   <!-- <h3>Tac Count by Top 5 os type and tac allocated month</h3> -->
													<div id="tacCountbyTop5OStypeAndTacAllocatedMonth" style="border-style: solid"></div>
                                                </div>
                                                
                                                <div class="col-md-6 mb-16">
                                                  <!--  <h3>Tac Count by Top 5 device type and tac allocated month</h3> -->
													<div id="tacCountbyTop5devicetypeAndTacAllocatedMonth" style="border-style: solid"></div>
                                                </div>
	...
	<script type="text/javascript"
		src="${context}/resources/project_js/viewsDashboardUsingTACAllocationDate.js?version=<%= (int) (Math.random() * 10) %>"></script>
			<script type="text/javascript"
