...
$(document).ready(function(){
  ...
  $('#whatIstopID').on('change', function() {
	...
	Top5BrandsForSeatelTillDate('AIRTEL');
	Top5ModelsForSeatelTillDate('AIRTEL');
	TopDeviceTypeForSeatelTillDate('AIRTEL');
	TopOSForSeatelwithPercentage('AIRTEL');
	TopMarketingNameForSeatelwithPercentage('AIRTEL');
	Top4SupportingTechnologywithPercentage('AIRTEL');
	arr=[];
	arr.push({"startDate": startDate, "endDate": endDate});
    MonthlyReportsData(arr);
    YearlyReportsData(arr);
...
function MonthlyReportsData(jsonData){
	try {
		MonthlyTopMarketingName(jsonData);
	}
	catch(err) {
	...
	try {
		MonthlyTopBrandName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		MonthlyTopModelName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		MonthlyTopDeviceType(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		MonthlyTopSupportingTech(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
...
function YearlyReportsData(jsonData){
	try {
		YearlyTopMarketingName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		YearlyTopBrandName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		YearlyTopModelName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		YearlyTopDeviceType(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		YearlyTopSupportingTech(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
...
function QuarterlyReportsData(jsonData){
	try {
		QuarterlyTopMarketingName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		QuarterlyTopBrandName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		QuarterlyTopModelName(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		QuarterlyTopDeviceType(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		QuarterlyTopSupportingTech(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
...
function MonthlyOperatorWiseReportsData(jsonData){
	
	try {
		MonthlyOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		InValidMonthlyOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		ValidMonthlyMobileOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		InValidMonthlyMobileOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
...
function YearlyOperatorWiseReportsData(jsonData){
	
	try {
		QtrOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		InValidQtrOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		ValidQtrMobileOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		InValidQtrMobileOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
...
function QuarterlyOperatorWiseReportsData(jsonData){
	
	try {
		yearlyOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		InValidyearlyOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		ValidyearlyMobileOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
	try {
		InValidyearlyMobileOperatorWise(jsonData);
	}
	catch(err) {
		console.error(err, err.stack);
	}
...
function MonthlyTopMarketingName(jsonData) {
    var request = {
        "reportnameId": 120,
       "typeFlag": 3,
       "top": topValues,
...
function QuarterlyTopMarketingName(jsonData) {
    var request = {
        "reportnameId": 120,
       "typeFlag": 5,
       "top": topValues,
...
function MonthlyTopBrandName(jsonData) {
    var request = {
        "reportnameId": 116,
       "typeFlag": 3,
       "top": topValues,
...
function YearlyTopBrandName(json) {
    var request = {
        "reportnameId": 116,
       "typeFlag": 4,
       "top": topValues,
...
function QuarterlyTopBrandName(json) {
    var request = {
        "reportnameId": 116,
       	"typeFlag": 5,
       	"top": topValues,
...
function MonthlyTopModelName(json) {
    var request = {
        "reportnameId": 117,
       "typeFlag": 3,
       "top": topValues,
...
function YearlyTopModelName(jsonData) {
    var request = {
        "reportnameId": 117,
       "typeFlag": 4,
       "top": topValues,
...
function QuarterlyTopModelName(jsonData) {
    var request = {
        "reportnameId": 117,
       "typeFlag": 5,
       "top": topValues,
...
function MonthlyTopDeviceType(json) {
    var request = {
        "reportnameId": 118,
       "typeFlag": 3,
       "top": topValues,
...
function YearlyTopDeviceType(jsonData) {
    var request = {
        "reportnameId": 118,
       "typeFlag": 4,
       "top": topValues,
...
function QuarterlyTopDeviceType(jsonData) {
    var request = {
        "reportnameId": 118,
       "typeFlag": 5,
       "top": topValues,
...
function MonthlyTopSupportingTech(json) {
    var request = {
        "reportnameId": 119,
       "typeFlag": 3,
       "top": topValues,
...
function YearlyTopSupportingTech(jsonData) {
    var request = {
        "reportnameId": 119,
       "typeFlag": 4,
       "top": topValues,
...
function QuarterlyTopSupportingTech(jsonData) {
    var request = {
        "reportnameId": 119,
       "typeFlag": 5,
       "top": topValues,
...
function quarterlyOsAndroid(json) {
    var request = {
        "reportnameId": 126,
       "typeFlag": 3,
       "top": topValues,
...
function monthlyOsAndroid(json) {
    var request = {
        "reportnameId": 126,
       "typeFlag": 4,
       "top": topValues,
...
function quarterlyDeviceType(json) {
    var request = {
        "reportnameId": 127,
       "typeFlag": 3,
       "top": topValues,
...
function monthlyDeviceType(json) {
    var request = {
        "reportnameId": 127,
       "typeFlag": 4,
       "top": topValues,
...
function yearlyDeviceType(json) {
    var request = {
        "reportnameId": 127,
       "typeFlag": 5,
       "top": topValues,
...
function MonthlyOperatorWise(json) {
    var request = {
        "reportnameId": 128,
       "typeFlag": 3,
       "top": topValues,
...
function yearlyOperatorWise(json) {
    var request = {
        "reportnameId": 128,
       "typeFlag": 4,
       "top": topValues,
...
function InValidMonthlyOperatorWise(json) {
    var request = {
        "reportnameId": 129,
       "typeFlag": 3,
       "top": topValues,
...
//Tab 7 Data Qtr on Qtr
function InValidQtrOperatorWise(json) {
    var request = {
        "reportnameId": 129,
       "typeFlag": 5,
       "top": topValues,
...
//Tab 8 Data Year on Year
function InValidyearlyOperatorWise(json) {
    var request = {
        "reportnameId": 129,
       "typeFlag": 4,
       "top": topValues,
...
//Tab 6 Data Month on Month
function ValidMonthlyMobileOperatorWise(json) {
    var request = {
        "reportnameId": 130,
       "typeFlag": 3,
       "top": topValues,
...
//Tab 7 Data Qtr on Qtr
function ValidQtrMobileOperatorWise(json) {
    var request = {
        "reportnameId": 130,
       "typeFlag": 5,
       "top": topValues,
...
//Tab 8 Data Year on Year
function ValidyearlyMobileOperatorWise(json) {
    var request = {
        "reportnameId": 130,
       "typeFlag": 4,
       "top": topValues,
...
function InValidMonthlyMobileOperatorWise(json) {
    var request = {
        "reportnameId": 131,
       "typeFlag": 3,
       "top": topValues,
...
//Tab 7 Data Qtr on Qtr
function InValidQtrMobileOperatorWise(json) {
    var request = {
        "reportnameId": 131,
       "typeFlag": 5,
       "top": topValues,
...
//Tab 8 Data Year on Year
function InValidyearlyMobileOperatorWise(json) {
    var request = {
        "reportnameId": 131,
       "typeFlag": 4,
       "top": topValues,
