		...
		/*	var dropdown=data.dropdownList;
			...
			*/	
			...
			var elem='<h1>'+data.pageTitle+'<h1>';	
				...
				$("#registrationTableButtonDiv").append("<div class='form-group'><button type='button' class='btn btn-outline-dark' onclick='exportAuditData()'>"+$.i18n('Export')+"<img src='./resources/assets/images/download-icon.svg' alt='icon' class='img-fluid ml-1'></button>");
