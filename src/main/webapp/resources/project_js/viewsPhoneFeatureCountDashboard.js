...
//DashBoard 3 : SmartPhone /Feature phone
function Top5Ostilldate() {
    var request = {
        "reportnameId": 108,
        "typeFlag": 1,
        "top": top,
    ...
    var containerName = "Top5Ostilldate_108";
    ajaxCall(request, containerName);
}

function Top2DeviceTypeTillDate() {
    var request = {
        "reportnameId": 107,
        "typeFlag": 1,
        "top": top,
        "searchString": " mobile_device_repository.device_type in ('Smartphone', 'Mobile Phone/Feature phone')",
        "dateRange": [
            {"startDate": startDate, "endDate": endDate}
        ]
    };
    var containerName = "Top2DeviceTypeTillDate_107";
    ajaxCall(request, containerName);
}

function Top2DeviceTypeAndOSTypeTillDate() {
    var request = {
        "reportnameId": 107,
        "typeFlag": 1,
        "top": top,
        "searchString": " mobile_device_repository.device_type in ('Smartphone', 'Mobile Phone/Feature phone') and  os = 'iOS'",
        "dateRange": [
            {"startDate": startDate, "endDate": endDate}
        ]
    };
    var containerName = "Top2DeviceTypeAndOSTypeTillDate_107";
    ajaxCall(request, containerName);
}
